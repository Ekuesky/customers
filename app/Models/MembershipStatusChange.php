...
final class MembershipStatusChange extends EloquentModel implements ActiveModel, Parseable, Relatable, GuardedModel
{
	 ...
	 * @var string
	 */
	protected $table = "cu_membership_status_changes";
	...
	public function membershipstatus(){
		return $this->belongsTo(MembershipStatus::class, 'current_status_id');
	}

	// public function MembershipStatusp(){
	// 	return $this->belongsTo(MembershipStatus::class, 'previous_status_id');
	// }

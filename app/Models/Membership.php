...
final class Membership extends EloquentModel implements ActiveModel, Parseable, Relatable, GuardedModel
{
	 ...
	 * @var string
	 */
	protected $table = "cu_memberships";
	...
	public function membertype(){
		return $this->belongsTo(MemberType::class, 'type');
	}
	...
	public function  membershipstatuschanges(){
		return $this->hasMany(MembershipStatusChange::class);
	}

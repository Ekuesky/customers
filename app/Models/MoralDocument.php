...
final class MoralDocument extends EloquentModel implements ActiveModel, Parseable, Relatable, GuardedModel
{
	 ...
	 * @var string
	 */
	protected $table = "cu_moral_documents";
	...
	public function documenttype(){
		return $this->belongsTo(DocumentsType::class, 'document_type_id');
	}

	public function moral(){
		return $this->belongsTo(Moral::class);
	}

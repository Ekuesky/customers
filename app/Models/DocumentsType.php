...
final class DocumentsType extends EloquentModel implements ActiveModel, Parseable, Relatable, GuardedModel
{
	 ...
	 * @var string
	 */
	protected $table = "cu_documents_type";
	...
	public function moraldocuments(){
		return $this->hasMany(MoralDocument::class);
	}

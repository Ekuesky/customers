...
final class MemberCategory extends EloquentModel implements ActiveModel, Parseable, Relatable, GuardedModel
{
	 ...
	 * @var string
	 */
	protected $table = "cu_member_categories";
	...
	public function membertype(){
		return $this->belongsTo(MemberType::class, 'memeber_type_id');
	}

...
class MoralSignatoryViewModel implements Validatable
{
	...
	public function rules()
	{
		...
		return [
			...
			"moral_id" => ['required_without:id','integer','exists:cu_morals,id'],
	...
	public function updateRules()
	{
		...
		return [
			...
			"moral_id" => ['sometimes','integer','exists:cu_morals,id'],
			"created_at" => ['nullable','date_format:Y-m-d H:i:s'],
			"updated_at" => ['nullable','date_format:Y-m-d H:i:s'],
		];
	}

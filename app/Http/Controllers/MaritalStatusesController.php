...
use App\Http\ViewModels\MaritalStatusViewModel;
use App\Dto\MaritalStatusDto;
...
final class MaritalStatusesController
{
	...
	public function __construct(Validator $validator, IActionResponseHandler $response, ActionHandler $service = null)
	{
		...
		$this->service = $service ?? new MaritalStatusService();
	}

	/**
	 * Display or Returns a list of items
	 * @Route /GET /marital-statuses[/{$id}]
	 * 
	...
	public function index(Request $request, string $id = null)
	{
		...
		$tranformFunc_ = function( $items) {
			return map_query_result($items, function ($value) {
				return $value ? (new MaritalStatusDto)->withModel($value) : $value;
			});
		};
		$filters = drewlabs_databse_parse_client_request_query(new MaritalStatus, $request);
	...
	public function show(Request $request, $id)
	{
		...
		$result = $this->service->handle(Action([
			...
			return null !== $value ? new MaritalStatusDto($value->toArray()) : $value;
		});
		return $this->response->ok($result);
	}
	...
	public function store(Request $request)
	{
		...
		$viewModel_ = (new MaritalStatusViewModel)->files($request->allFiles())->withBody($request->all());
	 ...
	 * @Route /PUT /marital-statuses/{id}
	 * @Route /PATCH /marital-statuses/{id}
	 * 
	 * @param Request $request
	 * @param mixed $id
	 *
	 ...
	 * @Route /DELETE /marital-statuses/{id}
	 * 
	 * @param Request $request
	 * @param mixed $id
	 *

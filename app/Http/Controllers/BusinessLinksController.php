...
use App\Services\BusinessLinkService;
use App\Models\BusinessLink;
use App\Http\ViewModels\BusinessLinkViewModel;
use App\Dto\BusinessLinkDto;
...
final class BusinessLinksController
{
	...
	public function __construct(Validator $validator, IActionResponseHandler $response, ActionHandler $service = null)
	{
		...
		$this->service = $service ?? new BusinessLinkService();
	}

	/**
	 * Display or Returns a list of items
	 * @Route /GET /business-links[/{$id}]
	 * 
	...
	public function index(Request $request, string $id = null)
	{
		...
		$tranformFunc_ = function( $items) {
			return map_query_result($items, function ($value) {
				return $value ? (new BusinessLinkDto)->withModel($value) : $value;
			});
		};
		$filters = drewlabs_databse_parse_client_request_query(new BusinessLink, $request);
	...
	public function show(Request $request, $id)
	{
		...
		$result = $this->service->handle(Action([
			...
			return null !== $value ? new BusinessLinkDto($value->toArray()) : $value;
		});
		return $this->response->ok($result);
	}
	...
	public function store(Request $request)
	{
		...
		$viewModel_ = (new BusinessLinkViewModel)->files($request->allFiles())->withBody($request->all());
	 ...
	 * @Route /PUT /business-links/{id}
	 * @Route /PATCH /business-links/{id}
	 * 
	 * @param Request $request
	 * @param mixed $id
	 *
	 ...
	 * @Route /DELETE /business-links/{id}
	 * 
	 * @param Request $request
	 * @param mixed $id
	 *

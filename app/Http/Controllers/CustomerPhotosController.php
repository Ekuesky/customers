...
use App\Http\ViewModels\CustomerPhotoViewModel;
use App\Dto\CustomerPhotoDto;
...
final class CustomerPhotosController
{
	...
	public function __construct(Validator $validator, IActionResponseHandler $response, ActionHandler $service = null)
	{
		...
		$this->service = $service ?? new CustomerPhotoService();
	}

	/**
	 * Display or Returns a list of items
	 * @Route /GET /customer-photos[/{$id}]
	 * 
	...
	public function index(Request $request, string $id = null)
	{
		...
		$tranformFunc_ = function( $items) {
			return map_query_result($items, function ($value) {
				return $value ? (new CustomerPhotoDto)->withModel($value) : $value;
			});
		};
		$filters = drewlabs_databse_parse_client_request_query(new CustomerPhoto, $request);
	...
	public function show(Request $request, $id)
	{
		...
		$result = $this->service->handle(Action([
			...
			return null !== $value ? new CustomerPhotoDto($value->toArray()) : $value;
		});
		return $this->response->ok($result);
	}
	...
	public function store(Request $request)
	{
		...
		$viewModel_ = (new CustomerPhotoViewModel)->files($request->allFiles())->withBody($request->all());
	 ...
	 * @Route /PUT /customer-photos/{id}
	 * @Route /PATCH /customer-photos/{id}
	 * 
	 * @param Request $request
	 * @param mixed $id
	 *
	 ...
	 * @Route /DELETE /customer-photos/{id}
	 * 
	 * @param Request $request
	 * @param mixed $id
	 *

...
use App\Http\ViewModels\AddressViewModel;
...
final class AddressesController
{
	...
	public function __construct(Validator $validator, IActionResponseHandler $response, ActionHandler $service = null)
	{
		...
		$this->service = $service ?? new AddressService();
	}
	...
	public function store(Request $request)
	{
		...
		$viewModel_ = (new AddressViewModel)->files($request->allFiles())->withBody($request->all());
